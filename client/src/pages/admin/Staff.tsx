...
import { ImageResizer } from "@/components/ui/image-resizer"; //Import ImageResizer
...
export default function StaffPage() {
  ...
  const [isResizerOpen, setIsResizerOpen] = useState(false); //Renamed to isResizerOpen
            ...
            <Card key={staffMember.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-6 flex flex-col items-center">
                ...
                <div className="flex space-x-3">
                  <Button variant="secondary" size="sm" onClick={() => handleOpenEditDialog(staffMember)}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    </svg>
                    Edit
                  </Button>
                  <Button variant="destructive" size="sm" onClick={() => handleOpenDeleteDialog(staffMember)}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    Remove
                  </Button>
                </div>
            ...
            <form onSubmit={createForm.handleSubmit(onCreateSubmit)} className="space-y-4">
              <FormField control={createForm.control} name="name" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Jane Smith" {...field} onChange={(e) => handleNameChange(e, "create")} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FormField control={createForm.control} name="initials" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Initials</FormLabel>
                    <FormControl>
                      <Input placeholder="JS" maxLength={2} {...field} value={field.value?.toUpperCase()} />
                    </FormControl>
              ...
              <FormField control={createForm.control} name="bio" render={({ field }) => (
                <FormItem>
                  <FormLabel>Biography</FormLabel>
                  <FormControl>
                    <Textarea placeholder="Brief description of experience and specialties..." className="min-h-[100px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />

              <FormField control={createForm.control} name="imageUrl" render={({ field }) => (
                <FormItem>
                  <FormLabel>Profile Image URL</FormLabel>
                  <FormControl>
                    <Input placeholder="https://example.com/image.jpg" {...field} />
                  </FormControl>
                  <FormDescription>Enter an image URL or leave blank to use initials.</FormDescription>
                  <FormMessage />
                </FormItem>
              )} />

              <div className="grid grid-cols-2 gap-4">
                <FormField control={createForm.control} name="sessions" render={({ field }) => (
                  <FormItem>
                ...
                <FormField control={createForm.control} name="rating" render={({ field }) => (
                  <FormItem>
              ...
              <FormField control={createForm.control} name="active" render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Active Status</FormLabel>
                    <FormDescription>Inactive staff members won't be shown to clients</FormDescription>
                  </div>
                  <FormControl>
            ...
            <form onSubmit={editForm.handleSubmit(onEditSubmit)} className="space-y-4">
              <FormField control={editForm.control} name="name" render={({ field }) => (
                <FormItem>
                  <FormLabel>Full Name</FormLabel>
                  <FormControl>
                    <Input placeholder="e.g. Jane Smith" {...field} onChange={(e) => handleNameChange(e, "edit")} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FormField control={editForm.control} name="initials" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Initials</FormLabel>
                    <FormControl>
                      <Input placeholder="JS" maxLength={2} {...field} value={field.value?.toUpperCase()} />
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField control={editForm.control} name="sessions" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Total Sessions</FormLabel>
                    <FormControl>
                      <Input type="number" min="0" {...field} />
                ...
                <FormField control={editForm.control} name="rating" render={({ field }) => (
                  <FormItem>
                    <FormLabel>Rating (0-5)</FormLabel>
                    <FormControl>
                      <Input type="number" min="0" max="5" step="0.1" {...field} />
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleDeleteConfirm} disabled={deleteStaff.isPending}>
